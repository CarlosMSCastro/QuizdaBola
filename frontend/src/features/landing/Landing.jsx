  ...
  return (
    <div className="min-h-[calc(100vh-16rem)] flex flex-col items-center justify-center p-3 gap-4 pt-5 relative">
      ...
      <button
        ...
        className="hidden md:block absolute top-12 right-20 hover:scale-105 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded-lg"
      >
