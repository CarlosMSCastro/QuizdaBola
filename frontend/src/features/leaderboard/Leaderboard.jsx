...
function Leaderboard() {
  ...
  const loadScores = async () => {
    ...
    try {
      ...
      const data = await getLeaderboard(gameMode, competitionId);
      setScores(data);
    } catch (error) {
      ...
      <div className="max-w-4xl mx-auto space-y-6 md:space-y-10">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            ...
            <span
              className={`text-muted-foreground transition-transform duration-300 ${leagueDropdownOpen ? "rotate-180" : ""}`}
              aria-hidden="true"
            >
              ▾
            </span>
              ...
              {leagues.map((lg) => {
                ...
                return (
                  ...
                  >
                    ...
                    {!isActive && (
                      <span
                        className="ml-auto px-2 py-1 rounded-full bg-primary/20 text-primary text-xs font-bold"
                        aria-hidden="true"
                      >
        ...
        {scores.length === 0 ? (
          ...
          <div className="dark:bg-card/80 bg-card/25 rounded-3xl overflow-hidden shadow-xl">
            ...
            <div className="hidden md:grid grid-cols-12 gap-4 px-8 py-6 dark:bg-muted/80 bg-muted/50">
              ...
              <div className="col-span-7 font-black text-base uppercase tracking-wider text-foreground">
                Jogador
              </div>
              <div className="col-span-3 font-black text-base uppercase tracking-wider text-foreground text-right">
                Score
              </div>
            </div>
